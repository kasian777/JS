...
// function massRandom (length) {
//     let massNAPOL = [];
//     for (let i = 0; i < length; i++){
//         massNAPOL.push(Math.floor(Math.random()*100));
//     }
// return massNAPOL
// }
//
// document.write(massRandom(14))
...
// function massRandom2 (limit2, size ) {
//     let massNAPOL1 = [];
//     for (let i = 0; i < size; i++){
//         massNAPOL1.push(Math.floor(Math.random()*limit2));
//     }
//     return massNAPOL1
// }
// document.write(`<div>`)
// document.write(massRandom2(7, 10 ))
// document.write(`</div>`)
